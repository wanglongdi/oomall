...
CM.intro = {
	start: function() {
		if ($('#chat_scroll').length) CM.intro.iniScr();
	}
	,
	iniScr: function(){
		var scroller  = null;
		var scrollbar = null;
		scroller  = new Scrolling.Scroller(document.getElementById('chat_scroll'), 430, 400);
		scrollbar = new Scrolling.Scrollbar(document.getElementById('chat_scroll_bar'), scroller, new Scrolling.ScrollTween());
}
};
////////////////////  start  ////////////////////
$(function() {
