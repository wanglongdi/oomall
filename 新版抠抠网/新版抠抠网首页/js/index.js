...
$(function(){
	$(window).scroll(function(){
		...
		if($(window).scrollTop()>600){
			//$("#header").find('h1').show();
			$("#header").find('h1').css('padding-top','3px')
			$("#header").find('.header_bg').show();
			$("#header").addClass('headerfixed');
			$("#header").find('#search').css('margin-top','20px');
			$("#header").find('.shopcar').css('margin-top','24px');;
			}
		else{
			//$("#header").find('h1').show();
			$("#header").find('h1').css('padding-top','11px')
			$("#header").find('.header_bg').hide();
			$("#header").removeClass('headerfixed');
			$("#header").find('#search').css('margin-top','38px');
